...
<form id="insert_category_form" action="" method="POST" class="mb-2">
    <div class="input-group w-90 mb-3">
        ...
        <input type="text" class="form-control" name="categ_title" id="categ_title" placeholder="Insert Categories" aria-label="categories" aria-describedby="basic-addon1">
    </div>
        ...
        $("#insert_category_form").validate({
            ...
            messages: {
                categ_title: {
                    ...
                    minlength: "Category title must be at least 3 characters long."
                }
            },
