...
<form id="insert_brand_form" action="" method="POST" class="mb-2">
    <div class="input-group w-90 mb-3">
        ...
        <input type="text" class="form-control" name="brand_title" id="brand_title" placeholder="Insert Brands" aria-label="Brands" aria-describedby="basic-addon1">
    </div>
